...
SELECT * FROM CUSTOMER AT(TIMESTAMP => '2023-06-17 12:56:43.446 +0000'::timestamp);
...
CREATE TABLE copy_cust CLONE CUSTOMER
  AT(TIMESTAMP => '2023-06-17 12:56:43.446 +0000'::timestamp);
